...
output "api_public_url" {
  ...
  value       = module.edge.api_public_url
}

output "admin_api_public_url" {
  description = "Admin API URL via CloudFront"
  value       = module.edge.admin_api_public_url
}

output "admin_public_url" {
  description = "Web-admin static site URL via CloudFront"
