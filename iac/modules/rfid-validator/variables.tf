...
variable "gate_commands_enabled" {
  description = "Publish MQTT gate commands when true"
  type        = bool
  default     = false
}

variable "lambda_role_arn" {
  description = "IAM role ARN for the rfid-validator Lambda"
  type        = string
}
...
variable "rfid_validations_table_name" {
  description = "DynamoDB RFIDValidations table name"
  type        = string
}
