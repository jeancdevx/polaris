...
describe('readDatabaseEnv', () => {
  it('uses DATABASE_URL when DB_* parts are not all present', () => {
  ...
  it('prefers live DB_* parts over a stale DATABASE_URL', () => {
    process.env.DATABASE_URL = 'postgresql://stale:oldpass@stale-host:5432/db'
